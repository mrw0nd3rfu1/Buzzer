...
public class ChatActivity extends AppCompatActivity {
    ...
    private void loadMoreMessages() {
        DatabaseReference messageDraft = mRootRef.child("Messages").child(mCurrentUserId).child(mChatUser);

        Query messageQuery = messageDraft.orderByKey().endAt(mLastKey).limitToLast(10);
    ...
    private void loadMessages() {
        ...
        Query messageQuery = messageDraft.limitToLast(mCurrentPage * TOTAL_ITEMS_TO_LOAD);
